...
subtitle: "Contested primaries for the state legislature, Governor's Council, Congress, and Senate"
author: "Brent Benson"
date: "2024-08-25"
...
office_primary_map <- function(office_group, geom, districts) {
    (tm_shape(geom %>%
              right_join((districts %>%
                          filter(office == office_group)),
                         by="district")) +
...
their is at least one party primary.
